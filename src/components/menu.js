...
function Pagination(props) {
    return (
        <>
            <h4 className="small font-weight-bold">{props.text}<span
                className="float-right">{props.per}</span></h4>
            <div className="progress mb-4">
                <div className={`progress-bar bg-${props.color}`} role="progressbar" style={{ width: `${props.per}` }}></div>
            </div>
...
function Card(props) {
    return (
        <>
            <div className="col-xl-3 col-md-6 mb-4 p-2" >
